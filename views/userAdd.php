<form action="<?= htmlspecialchars($_SERVER['PHP_SELF'])?>" method="POST" enctype="multipart/form-data" novalidate>
    ...
    <!-- Input date of birth -->
                    <div class="mb-3">
                        ...
                        <input name="date" type="date" value="<?= $date ?? '' ?>" required pattern="<?=REGEX_DOB?>" class="form-control" id="date"
    ...
    <!-- Select profil picture -->
                    <div class="mb-3">
                        <label for="Jpeg">Please submit a profil picture:</label>
                    </div>
                    <div class="mb-3">
                        <input name="Jpeg" type="file" accept="image/jpeg"  class="form-control" id="Jpeg">
                    </div>
                    <p class="error"><?= $error['Jpeg'] ?? '' ?></p>
